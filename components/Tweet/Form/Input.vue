    ...
    <div>
        <div class="flex items-center flex-shrink-0 p-4 pb-0">
            <div class="flex w-12 items-top">
                <img alt="" :src="props.user?.profileImage" class="inline-block w-10 h-10 rounded-full" />
            </div>
        ...
        <!-- File Selector -->
        <div class="p-4 pl-16">
            <img class="rounded-2xl border" :class="twitterBorderColor" :src="inputImageUrl" v-if="inputImageUrl" alt="" />
