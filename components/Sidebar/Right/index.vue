<template>
    <div class="flex flex-col">
        ...
        <div class="relative m-2">
            ...
            <input v-model="search" @keyup.native.enter="handleSearch" class="flex items-center w-full pl-12 text-sm font-normal bg-gray-100 border border-gray-100 rounded-full dark:text-white dark:bg-dim-400 dark:border-dim-400 focus:bg-white dark:focus:bg-dim-900  focus:outline-none focus:border focus:border-blue-200 h-9" 
                type="text"
            ...
            <SidebarRightPreviewCardItem v-for="whoToFollow in whoToFollowItems">
                <div class="flex flex-row items-center justify-between p-2">
                    ...
                    <div class="flex h-full">
                        <button class="px-4 py-2 text-xs font-bold text-white dark:text-black
